...
const QMetaObject afficheur::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_afficheur,
      qt_meta_data_afficheur, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &afficheur::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_afficheur))
        return static_cast<void*>(const_cast< afficheur*>(this));
